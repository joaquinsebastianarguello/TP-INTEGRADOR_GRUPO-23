class Mensaje:
    ...
    def __init__(self, remitente: str, destinatario: str, asunto: str, contenido: str, prioridad=False):
    ...
    def mostrar_mensaje(self):
        ...
        texto = "De: " + self.__remitente + "\n"   #\n deberia funcionar como un comando que hace una separacion en el texto (como un enter)
